...
* Installation (as of May 2020) tutorial: https://medium.com/@naomi.fridman/install-pyspark-to-run-on-jupyter-notebook-on-windows-4ec2009de21f 
  ...
  * 1) Change system PATH & ENV 
  * 2) Don't download the most up-to-date version of Java, download the **Java 8** from the link in the article - note that you need to sign up an Oracle account for this 
  * 3) Download & install **7.ZIP** in order to extract the .gz file from Apache Spark
